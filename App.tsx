...
const initialDemands: Demanda[] = [
  ...
  /* Fix: Added missing mesFaturamento for item 45712 */
  ...
  /* Fix: Added missing mesFaturamento for item 45781 */
  ...
  // PÁGINA 2
  /* Fix: Added missing dataConclusao and mesFaturamento for item 45946 */
  ...
  /* Fix: Added missing mesFaturamento for item 45964 */
  ...
  /* Fix: Added missing dataConclusao and mesFaturamento for item 46034 */
  ...
  /* Fix: Added missing dataConclusao and mesFaturamento for item 45679 */
  ...
  /* Fix: Added missing dataConclusao and mesFaturamento for item 46380 */
  ...
  /* Fix: Added missing dataConclusao and mesFaturamento for item 45316 */
  ...
  /* Fix: Added missing dataConclusao and mesFaturamento for item 45324 */
  ...
  /* Fix: Added missing dataConclusao and mesFaturamento for item 45507 */
  ...
  /* Fix: Added missing dataConclusao and mesFaturamento for item 46118 */
  ...
  /* Fix: Added missing dataConclusao and mesFaturamento for item 45976 */
  ...
  /* Fix: Added missing mesFaturamento for item 46548 */
  ...
  /* Fix: Added missing dataConclusao and mesFaturamento for item 55874 */
  ...
  /* Fix: Added missing dataConclusao and mesFaturamento for item 56132 */
  ...
  /* Fix: Added missing dataConclusao and mesFaturamento for item 62421 */
  ...
  /* Fix: Added missing dataConclusao and mesFaturamento for item 69672 */
...
const App: React.FC = () => {
  ...
  }, [demandas, empresas, catalogo, users, darkMode]);
